...
#define _l3_test_construct(uid, ...) \
	...
	L3_CONSTRUCTOR void _l3_test_constructor_name(uid) (void) { \
		...
		L3Test *test = L3TestDefine(@__FILE__, __LINE__, __VA_ARGS__, &_l3_test_function_name(uid)); \
...
L3_OVERLOADABLE L3Test *L3TestDefine(NSString *file, NSUInteger line, SEL subject, L3TestFunction function) {
	return [L3Test testWithSourceReference:L3SourceReferenceCreate(nil, file, line, nil, NSStringFromSelector(subject)) function:function];
}

L3_OVERLOADABLE L3Test *L3TestDefine(NSString *file, NSUInteger line, const char *subject, L3TestFunction function) {
	return [L3Test testWithSourceReference:L3SourceReferenceCreate(nil, file, line, nil, @(subject)) function:function];
}

L3_OVERLOADABLE L3Test *L3TestDefine(NSString *file, NSUInteger line, NSString *(*subject)(NSString *, NSDictionary *), L3TestFunction function) {
	return [L3Test testWithSourceReference:L3SourceReferenceCreate(nil, file, line, nil, L3TestSymbolForFunction((L3FunctionTestSubject)subject)) function:function];
}

L3_OVERLOADABLE L3Test *L3TestDefine(NSString *file, NSUInteger line, id (^subject)(id), L3TestFunction function) {
	return [L3Test testWithSourceReference:L3SourceReferenceCreate(nil, file, line, nil, L3TestSymbolForFunction((L3FunctionTestSubject)L3TestFunctionForBlock((L3BlockTestSubject)subject))) function:function];
}
...
#define l3_addTestSubjectTypeWithFunction(functionSubject) \
	L3_OVERLOADABLE L3Test *L3TestDefine(NSString *file, NSUInteger line, __typeof__(functionSubject) subject, L3TestFunction function) { \
		return [L3Test testWithSourceReference:L3SourceReferenceCreate(nil, file, line, nil, L3TestSymbolForFunction((L3FunctionTestSubject)subject)) function:function]; \
	}
...
#define l3_addTestSubjectTypeWithBlock(blockSubject) \
	L3_OVERLOADABLE L3Test *L3TestDefine(NSString *file, NSUInteger line, __typeof__(blockSubject) subject, L3TestFunction function) { \
		return [L3Test testWithSourceReference:L3SourceReferenceCreate(nil, file, line, nil, L3TestSymbolForFunction((L3FunctionTestSubject)L3TestFunctionForBlock((L3BlockTestSubject)subject))) function:function]; \
	}
